...
#include "mesos/NamespaceCommentCheck.h"
...
using mesos::NamespaceCommentCheck;

TEST(MesosNamespaceCommentCheckTest, Basic) {
...
TEST(MesosNamespaceCommentCheckTest, SingleLineNamespaces) {
  EXPECT_EQ(
      "namespace i { namespace j { } }",
      runCheckOnCode<NamespaceCommentCheck>("namespace i { namespace j { } }"));
}

TEST(MesosNamespaceCommentCheckTest, CheckExistingComments) {
...
TEST(MesosNamespaceCommentCheckTest, FixWrongComments) {
