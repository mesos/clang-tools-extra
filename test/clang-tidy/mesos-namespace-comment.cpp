// RUN: %check_clang_tidy %s mesos-namespace-comment %t
...
// CHECK-MESSAGES: :[[@LINE+4]]:2: warning: namespace 'n2' not terminated with a closing comment [mesos-namespace-comment]
